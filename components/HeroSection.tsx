    ...
    <main className="mt-7 overflow-hidden flex flex-col items-center justify-center text-center md:text-left">
      ...
      <section className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-8 items-center justify-center">
        ...
        <div className="md:col-span-7 flex flex-col items-center md:items-start justify-center">
          ...
          >
            Upload CSV, get automatic charts, and ask questions in plain
            English. Built for speed, clarity, and real-world decisions.
          </motion.p>
          ...
          >
            <Link href="/home">
              <button className="px-5 primarybg py-3 rounded-md text-white font-medium shadow-md cursor-pointer hover:brightness-95 transition flex items-center gap-2">
                Try It Free
                <ArrowRight size={16} />
              </button>
            </Link>
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-lg bg-[#F9F5FF] flex items-center justify-center text-xl">
                    📊
                  </div>
                  <div>
                    <h4 className="font-semibold">Smart charts</h4>
                    <p className="text-sm text-slate-600">
                      Auto-suggested visuals & quick edits.
                    </p>
                  </div>
                </div>
