...
import axiosInstance from "@/lib/axiosInstance"; // ✅ your axios setup
...
export default function UserManagementDashboard() {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        const res = await axiosInstance.get("admin/dashboard/getallusers");
        console.log("fetched counts:", res.data);
